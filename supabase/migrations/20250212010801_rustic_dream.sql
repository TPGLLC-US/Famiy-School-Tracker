/*
  ...
  2. Create materialized views for performance tracking
  3. Set up triggers for automatic view refreshing
  4. Add RLS policies for parent access
*/

-- Drop existing objects if they exist
DROP MATERIALIZED VIEW IF EXISTS student_performance_summary;
DROP MATERIALIZED VIEW IF EXISTS student_grade_trends;
